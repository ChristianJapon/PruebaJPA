 ...
 * @author japch
 */
public class Vistahipoteca extends javax.swing.JFrame {

    /**
     * Creates new form Vistahipoteca
     */
    public Vistahipoteca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vistahipoteca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vistahipoteca().setVisible(true);
            }
        });
    }
